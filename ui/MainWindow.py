...
"")
        ...
        self.ServerStartProgressButton = QProgressBar(self.tabGeneral)
        self.ServerStartProgressButton.setObjectName(u"ServerStartProgressButton")
        self.ServerStartProgressButton.setEnabled(True)
        self.ServerStartProgressButton.setGeometry(QRect(730, 30, 118, 23))
        self.ServerStartProgressButton.setStyleSheet(u"")
        self.ServerStartProgressButton.setValue(24)
        self.ServerStartProgressButton.setTextVisible(True)
        self.ServerStartProgressButton.setInvertedAppearance(False)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ServerUptimeInfo.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-weight:700;\">0d 0h 0m 0s</span></p></body></html>", None))
